...
#적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/박영웅/Desktop/python연습장/이온2파이썬/나도코딩/Pygame_basic/enemy.png")
enemy_size = character.get_rect().size   #.get_rect().size로 인해 캐릭터 이미지의 가로세로 크기 설정 
...
enemy_y_pos = (screen_height/2) - (enemy_height) # 화면 세로 크기의 가장 아래에 해당하는 곳에 위치
...
# 종료 직전 대기 
pygame.time.delay(2000) #2초 정도 대시(ms)
